...
export async function createOrder(input: { cartId: string; fulfillment: "delivery" | "pickup"; paymentMethod: "cod" | "online"; address?: string }) { const id = await request("/rpc/place_shop_order", { method: "POST", body: JSON.stringify({ p_cart_id: input.cartId, p_fulfillment: input.fulfillment, p_payment_method: input.paymentMethod, p_address: input.address || "" }) }) as string; return getOrder(id); }
